  ...
  <UContainer>
    <UPage>
      <template #left>
        <UPageAside
          :ui="{
            root: 'lg:max-h-[calc(100dvh-var(--ui-header-height)-(--spacing(8)))]',
          }"
        >
      ...
      <UPageBody class="space-y-8">
        ...
        <UCard
          id="getting-started"
          class="scroll-mt-[calc(var(--ui-header-height)+(--spacing(4)))]"
        >
          <template #header>
        ...
        <!-- 操作说明 -->
        <UCard id="usage" class="scroll-mt-[calc(var(--ui-header-height)+(--spacing(4)))]">
          <template #header>
            <div class="flex items-center gap-2">
        ...
        <!-- 已知问题 -->
        <UCard id="known-issues" class="scroll-mt-[calc(var(--ui-header-height)+(--spacing(4)))]">
          <template #header>
            <div class="flex items-center gap-2">
        ...
        <!-- 常见问题 -->
        <UCard id="faq" class="scroll-mt-[calc(var(--ui-header-height)+(--spacing(4)))]">
          <template #header>
            <div class="flex items-center gap-2">
        ...
        <!-- 反馈交流 -->
        <UCard id="feedback" class="scroll-mt-[calc(var(--ui-header-height)+(--spacing(4)))]">
          <template #header>
            <div class="flex items-center gap-2">
        ...
        <!-- 致谢 -->
        <UCard id="credits" class="scroll-mt-[calc(var(--ui-header-height)+(--spacing(4)))]">
          <template #header>
            <div class="flex items-center gap-2">
        ...
        <!-- 说明 -->
        <UCard id="disclaimer" class="scroll-mt-[calc(var(--ui-header-height)+(--spacing(4)))]">
          <template #header>
            <div class="flex items-center gap-2">
